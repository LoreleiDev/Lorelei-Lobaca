...
export default function BookEditForm({ initialBook, onSuccess }) {
    ...
    const [formData, setFormData] = useState({
        ...
        berat: initialBook.berat ? initialBook.berat.toString() : "",
        isbn: initialBook.isbn,
        tahun: initialBook.tahun.toString(),
        admin_id: initialBook.admin_id,
    });
    ...
    const handleSubmit = async (e) => {
        ...
        const result = await Swal.fire({
            ...
            text: "Apakah Anda yakin ingin menyimpan perubahan pada buku ini?",
            icon: "question",
        ...
        try {
            ...
            let fotoUrl = initialBook.foto;

            if (formData.foto instanceof File) {
                Swal.fire({
                    title: "Mengupload Gambar...",
                    text: "Sedang mengupload gambar baru",
                ...
                if (
                    initialBook.foto &&
                    initialBook.foto.startsWith("https://res.cloudinary.com/")
                ) {
                    try {
            ...
            const response = await fetch(
                `/api/admin/books/${initialBook.buku_id}`,
                {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
